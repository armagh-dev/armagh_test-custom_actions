...
module Armagh
  module CustomActions
    ...
    class TestConfigurableBehaviorDivide < Actions::Divide
      include Armagh::CustomSupport::BasicBehavior

      def divide(doc)

        log_debug { 'Test Configurable Divide Running' }
        ...
        generate_document_drafts( @config ) do |draft, dev_error, ops_error|
          ...
          create("I am content for #{draft['document_id']}", draft['metadata'] || {}) if draft
        end
      end
    end
  end
